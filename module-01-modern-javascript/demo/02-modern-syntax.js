 ...
 * Run: node module-01-modern-javascript/demo/02-modern-syntax.js
 */
...
console.log('\n--- Modern syntax demo ---\n');
console.log('Destructuring + defaults:', summarizeSighting({ name: 'Shadow', species: null }));
console.log('Spread merged record keys:', Object.keys(mergedTelemetry).slice(0, 5).join(', '), '...');

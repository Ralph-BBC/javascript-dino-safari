...
- **"But I can see sightings in the debugger"**: Yes — closures aren't security. They're encapsulation. External code can't *reference* the variable, but the debugger can inspect it.

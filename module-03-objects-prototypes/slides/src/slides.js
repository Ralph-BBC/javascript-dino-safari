export const slides = [
  {
    type: 'title',
    content: {
      title: 'Module 3 — Objects & Prototypes',
...
const splash = withSwim({ name: 'Splash' });`,
  ...
  },
  {
    type: 'modules',
    content: {
      title: 'Module 3 exercise themes',
      modules: [
  ...
  },
  {
    type: 'title',
    content: {
      title: 'Registry locked — Module 3',
      subtitle: 'Demos in module-03 then hit the exercises folder',
      icon: 'award',
    },
  },
];

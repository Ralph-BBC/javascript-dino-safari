...
console.log('  typeof null      =>', typeof null, '      — historic spec bug, null is NOT an object');
...
console.log('  -0 === 0           =>', -0 === 0, '  — strict equality says they are the same');
...
console.log('  NaN === NaN        =>', NaN === NaN, ' — the only JS value not equal to itself');
...
console.log('  isNaN("hello")     =>', isNaN('hello'), '  — global isNaN coerces first (dangerous)');
console.log('  Number.isNaN("hello") =>', Number.isNaN('hello'), ' — Number.isNaN does not coerce');
